...
const ModalFormularioTarea = () => {
    ...
    const { modalFormularioTarea, handleModalTarea, setAlerta, alerta, submitTarea, tarea } = useProyectos();
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            >
                                                <option value="" defaultValue="selected" disabled>-- Seleccione --</option>
